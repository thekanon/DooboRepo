...
# 테스트를 위해 창의적인 예시가 포함된 stories도 만들어줘

# 내가 제공한 Tree 및, 컴포넌트 작성 시 유의점을 확인하고, 만약 더 필요한 정보나 참고해야 할 정보가 있다면 코드 작성 전에 내게 필요한 정보를 물어봐줘
...
cat apps/docs/stories/Text.stories.tsx

위 정보를 기반으로 스토리북의 메인 페이지로 사용할 디자인 시스템 설명 mdx를 만들어줘
touch 명령어로 만들 수 있도록 작성해줘
테스트를 위해 stories도 만들어줘
